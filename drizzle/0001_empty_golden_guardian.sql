...
ALTER TABLE `resales` DROP FOREIGN KEY `resales_ticketId_tickets_id_fk`;
--> statement-breakpoint
ALTER TABLE `resales` ADD `ticketIds` json NOT NULL;--> statement-breakpoint
...
ALTER TABLE `tickets` ADD `pdfUrl` varchar(1000);--> statement-breakpoint
ALTER TABLE `tickets` ADD `assignedAt` timestamp;--> statement-breakpoint
...
ALTER TABLE `resales` DROP COLUMN `ticketId`;